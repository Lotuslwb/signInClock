...
var schoolList = [
    ...
    {
        cityNo: 'CQ',
        schoolArray: ["观音桥中心", "龙湖中心", "大坪时代天街中心", "南坪中心", "沙坪坝中心", "杨家坪中心", "江北北城天街中心"]
    },
    {
        cityNo: 'BT',
        schoolArray: ["包头中心"]
    ...
    {
        cityNo: 'CD',
        schoolArray: ['顺城中心', '紫荆中心', '沙湾中心', '优品道中心', '高新世豪广场中心', 'SM广场', '大悦城中心', '万象城(青少儿)中心', '温江中心']
    },
    {
        cityNo: 'CX',
        schoolArray: ['慈溪中心']
    ...
    {
        cityNo: 'HZ',
        schoolArray: ["城东中心", "城北中心", "武林中心", "临平中心", "滨江中心", "萧山中心", "城西银泰中心", "城西学院路中心"]
    },
    {
        cityNo: 'HEB',
        schoolArray: ["哈尔滨中心"]
    ...
    {
        cityNo: 'WLMQ',
        schoolArray: ['民主路中心', '友好中心', '铁路局中心', '昊元中心']
    },
    {
        cityNo: 'WHai',
        schoolArray: ['威海中心']
    ...
    {
        cityNo: 'XA',
        schoolArray: ['小寨中心', '高新中心', '交大中心', '经开中心', '曲江中心']
    },
    {
        cityNo: 'XS',
        schoolArray: ['萧山中心']
    ...
    {
        cityNo: 'ZZ',
        schoolArray: ['中环百货中心', '青少年宫中心', '宝龙广场中心', '普罗旺世中心','索易儿童中心']
    },
    {
        cityNo: 'ZJ',
        schoolArray: ['镇江中心']
